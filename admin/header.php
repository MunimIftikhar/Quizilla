...
<div id="header">
    ...
    font-weight: bold; color: white">SignUp</label></a></li>
                    ...
                    {
                        ?>
                        <li> <a href="addcourses.php"><i class="fa fa-sign-in-alt" style="color: white"></i><label style="font-size: medium; font-family: cursive;
    font-weight: bold; color: white"><?php echo $_SESSION['adminName']; ?></label></a></li>
                        <li> <a href="addcourses.php"><i class="fa fa-sign-in-alt" style="color: white"></i><label style="font-size: medium; font-family: cursive;
    font-weight: bold; color: white">AddCourse</label></a></li>
                        <li> <a href="addquizzez.php"><i class="fa fa-sign-in-alt" style="color: white"></i><label style="font-size: medium; font-family: cursive;
    font-weight: bold; color: white">AddQuizzez</label></a></li>
